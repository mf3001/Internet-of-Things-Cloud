...
# Account Information
to = 'fir.doris@gmail.com, lizhengrong920211@gmail.com,fmy9209@gmail.com'
# Email to send to.
gmail_user = 'fir.doris@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'Doris1234_' # Gmail password.
